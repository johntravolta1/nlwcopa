    ...
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center'>
      <main>
        ...
        <div className='mt-10 flex items-center gap-2'>
          <Image src={usersAvatarExampleImg} quality={100} alt=''></Image>
      ...
      <div className='mt-10 pt-10 border-t border-gray-600 flex items-center text-gray-100 flex justify-between'>
